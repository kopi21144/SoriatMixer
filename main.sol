...
contract SoriatMixer {
    ...
    function peekNote_21(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_22(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_23(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_24(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_25(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_26(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_27(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_28(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_29(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_30(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_31(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_32(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_33(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_34(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_35(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_36(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_37(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_38(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_39(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_40(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_41(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_42(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_43(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_44(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekNote_45(bytes32 noteId) external view returns (
        uint256 potId,
        address depositor,
        uint8 tier,
        uint256 locked,
    ...
    function peekPot_5(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_6(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_7(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_8(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_9(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_19(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_20(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_21(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_22(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_23(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_24(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_25(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_26(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
    ...
    function peekPot_27(uint256 potId) external view returns (
        uint32 notes,
        uint32 batches,
        uint256 weight,
        uint8 tier,
